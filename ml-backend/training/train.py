...
def train(args):
    ...
    # Using LSGAN (Least Squares GAN) with MSELoss for superior gradient stability
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(f"--> Epoch {epoch} Complete. Average D_Loss: {avg_d_loss:.4f}, G_Loss: {avg_g_loss:.4f}, L1: {avg_l1_loss:.4f}")
        ...
        if epoch % 5 == 0:
            ...
            with torch.no_grad():
                ...
                save_image(comparison, sample_dir / f"epoch_{epoch}.png", nrow=4)
                print(f"[SAMPLE] Saved comparison image grid to {sample_dir}/epoch_{epoch}.png")
